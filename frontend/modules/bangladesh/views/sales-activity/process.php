            ...
            [
                ...
                'template'=>'{view}  {edit}',
                    ...
                    'urlCreator' => function ($action, $model, $key, $index) {
                        ...
                        if ($action === 'view') {
                            $url = ['value'=>Url::to(['sales-activity-log/view','id'=>$model->id]),'class'=>'btn btn-sm blue-chambray activityView','title'=>'View'];
                            return $url;
                        }
                        if ($action === 'edit') {
                            $url = ['value'=>Url::to(['sales-activity-log/update','id'=>$model->id]),'class'=>'btn btn-sm blue-chambray activityUpdate','title'=>'Edit'];
                            return $url;
                        }
