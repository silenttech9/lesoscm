        ...
        <div class="portlet light ">
            ...
            <div class="portlet-body">
                        ...
                        <div class="panel panel-primary" id="show-customer">
                            ...
                            <div class="panel-body"> <?= $this->render('customer', ['model2'=> $model2,'module_id'=>$model->module_id] ); ?> </div>
                        </div>
                                    ...
                                    'template'=>'{log}   {edit}',
                                        'buttons' => [
                                            'log' => function ($url, $model) {
                                                return Html::a('History',FALSE, $url);
                                        ...
                                        'urlCreator' => function ($action, $model, $key, $index) {
                                            if ($action === 'log') {
                                                $url = ['value'=>Url::to(['/bangladesh/telemarketing-history/view','id'=>$model->id]),'class'=>'customerLog btn btn-sm blue-chambray','title'=>'Log History'];
                                                return $url;
                                            }
                                            if ($action === 'edit') {
