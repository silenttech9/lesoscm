 ...
 */
class QuotationDetailsBangladeshController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => QuotationDetailsBangladesh::find(),
        ]);
    ...
    {
        $model = new QuotationDetailsBangladesh();
    ...
    public function actionDelete($id,$quotation_id)
    {
        ...
        return $this->redirect(['/bangladesh/quotation-bangladesh/stock','id'=>$quotation_id]);
    }
    ...
    {
        if (($model = QuotationDetailsBangladesh::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function actionEdit($id,$item)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['/bangladesh/quotation-bangladesh/stock', 'id' => $model->quotation_id]);
        } else {
