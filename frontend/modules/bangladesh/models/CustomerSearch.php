...
/**
 * CustomerSearch represents the model behind the search form about `frontend\modules\thailand\models\Customer`.
 */
class CustomerSearch extends Customer
{
    ...
    {
        return [
            [['id', 'term_id', 'area_code_id', 'agent_id', 'staxcode_id', 'state_id', 'country_id', 'enter_by', 'update_by', 'render_state_id', 'module_id'], 'integer'],
