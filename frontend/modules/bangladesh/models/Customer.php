...
class Customer extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            [['address'], 'string'],
            [['term_id', 'area_code_id', 'agent_id', 'staxcode_id', 'state_id', 'country_id', 'enter_by', 'update_by', 'render_state_id', 'module_id','type_cust'], 'integer'],
    ...
    public function getTypecust()
    {
        return $this->hasOne(LookuproleCust::className(),['id'=>'type_cust']);
    }
}
