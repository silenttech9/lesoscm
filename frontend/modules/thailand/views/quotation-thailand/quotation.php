    ...
    <div class="full-height-content-body">
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="invoice-title uppercase">Unit Price (BAHT)</th>
                                            <th class="invoice-title uppercase">Amount (BAHT)</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                    ...
                    <div class="row invoice-subtotal">
                        <div class="col-xs-2">
                            ...
                            <p class="invoice-desc">BAHT <?php echo $total; ?></p>
                        </div>
                         <?php foreach ($model_quotation as $key => $value) { ?>
                            ...
                            <div class="col-xs-2">
                                <h2 class="invoice-title uppercase">VAT (7%)</h2>
                                <p class="invoice-desc">7 %</p>
                            </div>
                            <div class="col-xs-2">
                                <h2 class="invoice-title uppercase">Total</h2>
                                <p class="invoice-desc grand-total">BAHT <?php $totgst = $total * 0.07; echo number_format((float)$totgst+$total,2,'.',','); ?></p>
                            </div>
                            ...
                            <?php } else { ?>
                                ...
                                <div class="col-xs-2">
                                    <h2 class="invoice-title uppercase">Total</h2>
                                    <p class="invoice-desc grand-total">BAHT <?php $totgst = $afterDis * 0.07; echo number_format((float)$totgst+$afterDis,2,'.',','); ?></p>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <?php if ($model->status == "Progress") { ?>
                                <?= Html::a('Add Item', ['quotation-thailand/stock','id'=>$id],['class'=>'btn btn-lg blue-chambray hidden-print uppercase']) ?>
                            <?php } else { ?>
                                <?= Html::a('Edit Item',['quotation-thailand/revise','id'=>$id,'country_id'=>3],['class'=>'btn btn-lg blue-chambray hidden-print uppercase']) ?>
                            <?php } ?>
                            <?= Html::a('Edit Customer Info', ['quotation-thailand/update','id'=>$id],['class'=>'btn btn-lg blue-chambray hidden-print uppercase']) ?>

                            <?= Html::a('History', ['quotation-thailand/info','id'=>$id],['class'=>'btn btn-lg blue-chambray hidden-print uppercase']) ?>

                            <?php if ($model->status == "Progress") { ?>
                                <?= Html::a('Generate Quotation', ['quotation-thailand/generate','id'=>$id],['class'=>'btn btn-lg green-haze hidden-print uppercase print-btn']) ?>
                            <?php } else { ?>
                                <?= Html::a('PRINT PDF', ['quotation-thailand/pdf','id'=>$id,'country_id'=>3],['target' => '_blank','class'=>'btn btn-lg green-haze hidden-print uppercase print-btn']) ?>
                            <?php } ?>
