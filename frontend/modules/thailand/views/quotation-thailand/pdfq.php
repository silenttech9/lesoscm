...
<table style="width: 100%;">
    ...
    <tr><td></td></tr>
        ...
        <tr>
            ...
            <td>VAT @ 7 %</td>
            <td style="text-align: left;vertical-align: top;padding: 5px;">
                <span style="font-size:14px;"><b style="color: red;"><?php echo number_format((float)$total * 0.07,2,'.',','); ?></b></span>
            </td>
        </tr>
            ...
            <tr>
                ...
                <td>VAT @ 7 %</td>
                <td style="text-align: left;vertical-align: top;padding: 5px;">
                    <span style="font-size:14px;">( <b style="color: red;"><?php  echo $totgst = number_format((float)$afterDis * 0.07,2,'.',','); ?></b> )</span>
                </td>
            </tr>
...
<?php foreach ($info as $key => $value_info) { ?>
        <tr>
            ...
            <td style="text-align: right;vertical-align: top;padding: 5px;">
             ...
             <td style="text-align: right;vertical-align: top;padding: 5px;">
             <?php if ($value_info['discount'] == "" || $value_info['discount'] == 0) { ?>
             <span style="font-size:14px;"><?php $totgst = $total * 0.07; echo number_format((float)$totgst+$total,2,'.',','); ?></span>
             <?php } else { ?>
             <span style="font-size:14px;"><?php $afterDisC = $total - $value_info['discount']; $afterGst =  $afterDisC * 0.07;
