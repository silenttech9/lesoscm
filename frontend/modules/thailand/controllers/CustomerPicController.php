...
class CustomerPicController extends Controller
{
    ...
    public function actionCreate($id,$module_id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            return $this->redirect(['/thailand/customer/update', 'id' => $id,'module_id'=>$module_id]);
    ...
    public function actionUpdate($id,$module_id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            return $this->redirect(['/thailand/customer/update', 'id' => $model->customer_id,'module_id'=>$module_id]);
        } else {
    ...
    public function actionDelete($id,$customer_id,$module_id)
    {
        ...
        return $this->redirect(['/thailand/customer/update', 'id' => $customer_id,'module_id'=>$module_id]);
    }
