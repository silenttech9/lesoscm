...
use Yii;
use frontend\modules\malaysia\models\Telemarketing;
use frontend\modules\malaysia\models\TelemarketingSearch;
use frontend\modules\malaysia\models\TelemarketingCustomer;
use frontend\modules\malaysia\models\TelemarketingCustomerSearch;
use frontend\modules\malaysia\models\TelemarketingHistory;
...
class TelemarketingController extends Controller
{
    ...
    public function actionIndex($state_id)
    {
        ...
        $dataProvider->query->andWhere(['telemarketing.state_id'=>$state_id]);
     ...
     * @return mixed
     */
    public function actionDelete($id,$state_id)
    {
