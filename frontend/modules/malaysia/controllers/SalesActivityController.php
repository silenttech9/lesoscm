...
use frontend\modules\malaysia\models\SalesActivitySearch;
use frontend\modules\malaysia\models\SalesActivityLog;
use frontend\modules\malaysia\models\SalesActivityLogSearch;
...
class SalesActivityController extends Controller
{
    ...
    public function actionIndex($state_id)
    {
        ...
        $dataProvider->query->andWhere(['sales_activity.state_id'=>$state_id]);
    ...
    public function actionOversea($state_id)
    {
        $searchModel = new SalesActivitySearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        $dataProvider->query->andWhere(['sales_activity.state_id'=>$state_id]);
