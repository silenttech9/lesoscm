...
/* @var $searchModel frontend\modules\malaysia\models\PenangInvoiceSearch */
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet-title">
            ...
            <div class="actions">
                <b><?php /*Html::a('<i class="fa fa-upload"></i>',FALSE, ['value'=>Url::to(['penang-invoice/upload','state_id'=>$state_id]),'class' => 'uploadExcel btn btn-circle btn-icon-only blue-chambray','id'=>'uploadExcel','title' => 'Upload',]) */?></b>
                        ...
                        [
                            ...
                            'template'=>'{view}  {warranty}',
                                ...
                                'urlCreator' => function ($action, $model, $key, $index) {
                                    if ($action === 'view') {
                                        $url = ['view','id'=>$model->id,'state_id'=>23];
                                        return $url;
                                    }
                                    if ($action === 'warranty') {
                                        $url = ['/warranty/create','id'=>$model->id,'state_id'=>23];
                                        return $url;
                                    }
