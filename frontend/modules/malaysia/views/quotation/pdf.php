<table>
    <tr>
        <td style="text-align: left;vertical-align: top;">
            ...
            <span style="font-size:12px;"><?= $company->registeration_no; ?></span>,
            <span style="font-size:12px;">GST Registeration No. : <?= $company->gst_no; ?></span>
        </td>
    </tr>
    <tr>
        <td style="text-align: left;vertical-align: top;">
...
<?php if ($tax == "ZRE") { ?>
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <td style="text-align: left;vertical-align: top;padding: 5px;">
                <span style="font-size:14px;"><?php echo number_format((float)$value['price'],2,'.',','); ?>
                </span>
            </td>
            <td style="text-align: left;vertical-align: top;padding: 5px;">
...
<?php foreach ($model_quotation as $key => $value) { ?>
        ...
        <tr>
            <td style="text-align: left;vertical-align: top;padding: 5px;"><span style="font-size:14px;">Validity : <?php echo $value['validity']; ?></span></td>
        </tr>
...
<br>
<?php if (Yii::$app->request->get('state_id') == 20 ) { ?>
...
<?php foreach ($model_quotation as $key => $value) { ?>
        <tr>
            ...
            <td style="text-align: right;vertical-align: top;padding: 5px;">
                 ...
                 <?php } else { ?>
                 <span style="font-size:14px;"><?php $afterDisC = $total - $value['discount']; $afterGst =  $afterDisC * 0.06; 
