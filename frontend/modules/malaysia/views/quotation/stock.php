        ...
        <div class="portlet light ">
            <div class="portlet-title">
                ...
                <div class="actions">
                    ...
                    <b><?= Html::a('<i class="fa fa-clipboard"></i>', ['quotation', 'id' => $model->id,'state_id'=>$model->state_id], ['class' => 'btn blue-chambray','title' => 'View Quotation']) ?></b>

                    <b><?= Html::a('Revise', ['revise', 'id' => $model->id,'state_id'=>$model->state_id], ['class' => 'btn blue-steel','title' => 'Revise']) ?></b>
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                ...
                <div class="actions">
                    ...
                    <b><?= Html::a('<i class="fa fa-cubes"></i>', FALSE, ['value'=>Url::to(['/stock/add','id'=>$model->id,'module_id'=>1]),'class' => 'btn blue-steel create','id'=>'create','title' => 'New Item']) ?></b>
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                ...
                <div class="actions">
                    ...
                    <b><?= Html::a('<i class="fa fa-sort-amount-asc"></i>', FALSE, ['value'=>Url::to(['quotation/discount','id'=>$model->id]),'class' => 'btn blue-chambray discount showDiscount','id'=>'discount','title' => 'Discount']) ?></b>
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($data)
                {
                    ...
                    $show = Html::a($data->extra_description,FALSE, ['value'=>Url::to(['quotation-details/description','id'=>$data->id]),'class' => 'showBg','id'=>'showBg']);
            ...
            [
                ...
                'value' => function ($data)
                {
                    $show = '<b>Quantity : </b> '. Html::a($data->quantity,FALSE, ['value'=>Url::to(['quotation-details/edit','id'=>$data->id,'item'=>'quantity']),'class' => 'show','id'=>'show']). '
                    <br><b>Unit of Measure : </b> '.Html::a($data->uom->unit_of_measure,FALSE, ['value'=>Url::to(['quotation-details/edit','id'=>$data->id,'item'=>'unit']),'class' => 'show','id'=>'show']).'
                    <br><b>Price : </b> '.Html::a(number_format((float)$data->price,2,'.',','),FALSE, ['value'=>Url::to(['quotation-details/edit','id'=>$data->id,'item'=>'price']),'class' => 'show','id'=>'show']).'
                    <br><b>Total Price : </b> '.number_format((float)$data->quantity * $data->price,2,'.',',').'
                ...
                'template'=>'{delete}',
                    ...
                    'urlCreator' => function ($action, $model, $key, $index) {
                       /* if ($action === 'edit') {
                        ...
                        if ($action === 'delete') {
                            $url = ['quotation-details/delete','id'=>$model->id,'quotation_id'=>$model->quotation_id];
                            return $url;
                        }
                    }
                ],
