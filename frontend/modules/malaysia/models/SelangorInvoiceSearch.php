...
/**
 * SelangorInvoiceSearch represents the model behind the search form about `frontend\modules\malaysia\models\SelangorInvoice`.
 */
class SelangorInvoiceSearch extends SelangorInvoice
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['date', 'ref_no', 'item_no', 'description', 'quantity', 'selling_price', 'amount', 'company_name', 'agent','globalSearch'], 'safe'],
        ];
    }
