...
/**
 * JohorStockSearch represents the model behind the search form about `frontend\modules\malaysia\models\JohorStock`.
 */
class JohorStockSearch extends JohorStock
{
    /**
     * @inheritdoc
     */
