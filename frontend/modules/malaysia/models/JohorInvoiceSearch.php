...
/**
 * JohorInvoiceSearch represents the model behind the search form about `frontend\modules\malaysia\models\JohorInvoice`.
 */
class JohorInvoiceSearch extends JohorInvoice
{
    /**
     * @inheritdoc
     */
