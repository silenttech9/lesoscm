...
/**
 * PenangStockSearch represents the model behind the search form about `frontend\modules\malaysia\models\PenangStock`.
 */
class PenangStockSearch extends PenangStock
{
    /**
     * @inheritdoc
     */
