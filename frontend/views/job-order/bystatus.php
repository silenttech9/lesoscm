    ...
    <div class="col-lg-12 col-xs-12 col-sm-12">
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject font-blue-dark bold uppercase"><?= Yii::$app->request->get('status') ?></span>
                </div>
                ...
                <br><br>
                 <?php echo $this->render('_searchbystatus_page', ['model' => $searchModel,'render_state_id'=>$render_state_id,'status'=>$status]); ?>
                <div class="row">
