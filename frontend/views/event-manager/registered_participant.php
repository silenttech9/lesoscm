...
$this->title = 'Registered Participant';
            ...
            <div class="row">
                <div class='col-xs-12 table-responsive'>
                    <div class="portlet-body">
                        ...
                        <?php echo $this->render('_searchtitle_registered', ['model' => $searchModel]); ?>
                        <br><br><br>
                        <?php Pjax::begin(); ?>    <?= GridView::widget([
                                ...
                                'columns' => [
                                    ...
                                    [
                                            ...
                                            'template'=>'{registered_}',
                                            'buttons' => [
                                                'registered_' => function ($url, $model) {
                                                    return Html::a('View Participant', 
