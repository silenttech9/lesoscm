...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet-title">
            ...
            <div class="actions">
                 <b><?= Html::a('Create',FALSE, ['value'=>Url::to(['lookup-area/create','module_id'=>$module_id]),'class' => 'btn blue-steel create','id'=>'create']) ?></b>
                        ...
                        [
                            ...
                            'template'=>'{view}   {edit}   {delete}',
                                ...
                                'urlCreator' => function ($action, $model, $key, $index) {
                                    if ($action === 'view') {
                                        $url = ['value'=>Url::to(['lookup-area/view','id'=>$model->id]),'class'=>'btn btn-circle btn-icon-only blue-chambray view','title'=>'View'];
                                        return $url;
                                    }
                                    if ($action === 'edit') {
                                        $url = ['value'=>Url::to(['lookup-area/update','id'=>$model->id]),'class'=>'btn btn-circle btn-icon-only blue-chambray update','title'=>'Edit'];
                                        return $url;
                                    }
                                    if ($action === 'delete') {
                                        $url = ['lookup-area/delete','id'=>$model->id,'module_id'=>$model->module_id];
                                        return $url;
                                    }
                                }
                            ],
